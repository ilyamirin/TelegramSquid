...
def main():
    ...
    argument_parser.add_argument("-c", "--config", help="path to your config file", default=os.getenv("CONFIG_FILE", "config.yml"))

    sub_command_parser = argument_parser.add_subparsers(dest="command", required=True, help='command to execute')
    ...
    tg_client = TelegramClient(
        session=os.path.expanduser(get_config("telegram.session_file")),
